<template>
  <div class="home-container">
    <div class="content">
      <div class="text">
          <h2 class="title">一次温暖的对话</h2><br>
          <span class="highlight-text">化孤独为慰藉</span>
          <p class="description">每个深夜，每个焦虑的时刻，我们都在这里。不必独自承受，让心与心得连接温暖您的每一天</p>
          <div class="hero-actions">
            <el-button size="large">开始倾诉，获得陪伴</el-button>
            <el-button size="large" style="border-color: #fff; background-color: transparent; color: #fff;">开始倾诉，获得陪伴</el-button>
          </div>
        </div>
      <div class="robot">
        <img :src="iconUrl" alt="AI 胾神" />
      </div>
    </div>
  </div>
</template>
